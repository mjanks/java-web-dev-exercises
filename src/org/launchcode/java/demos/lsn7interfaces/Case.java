...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Chocolate Chips", 0.50, new ArrayList<>(Arrays.asList( "dairy")));
        Topping topping2 = new Topping("Sprinkles", 0.25, new ArrayList<>(Arrays.asList( "dairy", "gelatin")));
        Topping topping3 = new Topping("Peanuts", 0.25, new ArrayList<>(Arrays.asList( "nuts")));
        Topping topping4 = new Topping("The Works", 1.00, new ArrayList<>(Arrays.asList( "dairy", "nuts", "gelatin")));
        Topping topping5 = new Topping("Hot Fudge", 0.75, new ArrayList<>(Arrays.asList( "dairy")));
